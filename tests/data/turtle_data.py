...
def random_turtle_data():
    ...
    test_data=[
        ...
        param(
            Coord(-2, -3),
            10,
            [Vector(dx=-1, dy=-1), Vector(dx=1, dy=1), Vector(dx=-1, dy=-1), Vector(dx=-1, dy=-1), Vector(dx=-1, dy=-1), Vector(dx=1, dy=-1), Vector(dx=-1, dy=1), Vector(dx=-1, dy=-1), Vector(dx=1, dy=-1), Vector(dx=-1, dy=1)],
